            ...
            <tbody className="text-slate-600 text-sm font-normal">
              {projects.map((item, idx) => (
                <tr key={item.id} className="border-b border-gray-200  cursor-pointer">
                  <td className="py-3 px-6 hover:underline" onClick={() => getProjectHere(item.id)}>{idx + 1}</td>
                  <td className="py-3 px-6 hover:underline" onClick={() => getProjectHere(item.id)}>{item.title}</td>
                  <td className="py-3 px-6 hover:underline" onClick={() => getProjectHere(item.id)}>{item.key}</td>
                  <td className="py-3 px-6 hover:underline" onClick={() => getProjectHere(item.id)}>{item.owner.username}</td>
                  <td className="py-3 px-6 hover:opacity-80" onClick={() => deleteProjectHere(item.id)}>
